...
import com.project.xeroserver.Common.DirectionJSONParser;
...
public class DeliveryMap extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private void displayLocation() {
        ...
        else
        {
            ...
            if(mLastLocation !=null)
            {
                ...
                drawRoute(loc,Common.currentRequest.getAddress());
            }
            else
            {
    ...
    private void drawRoute(final LatLng loc, String address) {
        mService.getGeoCode(address).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try{
                    ...
                    //draw route
                    mService.getDirections(loc.latitude+","+loc.longitude,
...
LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient,mLocationRequest, this);
   ...
   /* @Override
    ...
    private class ParseTask extends AsyncTask<String,Integer, List<List<HashMap<String,String>>>> {
        ProgressDialog mDialog = new ProgressDialog(DeliveryMap.this);
